# MathClans V2.1.1 — Clan Approval & School-Safe Chat

V2.1.1 builds on the V2.0 school-wide release with leader-approved clan membership and school-safe Main/Clan chat, while preserving adaptive training, live multiplayer battles, rankings and administration.
...
## V2.1.1 — Clan Membership Approval & School-Safe Chat
...
The V2.1.1 language filter is suitable for the school beta client, but a public/commercial release should move language moderation and rate-limiting to trusted server-side Cloud Functions or another moderation service so modified clients cannot bypass it.
